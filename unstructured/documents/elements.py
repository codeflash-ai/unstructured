...
class DataSourceMetadata:
    ...
    def from_dict(cls, input_dict: dict[str, Any]):
        ...
        supported_fields = getattr(cls, "_from_dict_supported_fields", None)
        if supported_fields is None:
            supported_fields = frozenset(f.name for f in dc.fields(cls))
            setattr(cls, "_from_dict_supported_fields", supported_fields)
